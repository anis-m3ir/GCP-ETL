...
# =============================================================================
#Après ce bloc, Terraform a accès à des attributs comme :
...
# =============================================================================
# 3 Service account : 
    # cloudbuild-sa for -artifact registry -GCP API (terraform) -Secret Manager -Cloud Run Jobs
    # retail-etl-sa for -GCS -BigQuerry -Cloud Run Jobs -Cloud Workflows
    # dbt-runner -BigQuerry -Secret Manager(clé)
...
# =============================================================================
# IAM - SERVICE AGENT PERMISSIONS  PUBSUB
# =============================================================================
# Grant GCP service agents necessary permissions for Pub/Sub
# il faut créer le service identity avant lancement de terraform
...
# =============================================================================
# IAM - SERVICE AGENT PERMISSIONS  EVENTARC
# =============================================================================
# Grant GCP service agents necessary permissions for Eventarc
# il faut créer le service identity avant lancement de terraform
...
# TRIGGERS 
#C'est un **mécanisme de détection de changement** — si l'ID d'un de ces SA change, `time_sleep` est **détruit puis recréé**, ce qui force une nouvelle attente de 60s.
  triggers = {
